...
/** Load role + expert application gate state (parallel queries, request-memoized). */
export const loadAccessSnapshot = cache(
  async (userId: string): Promise<AccessSnapshot | null> => {
